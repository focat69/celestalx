...
local function OVIEZXC_fake_script() -- Main.Dragify 
...
coroutine.wrap(OVIEZXC_fake_script)()
local function UNQD_fake_script() -- close.LocalScript 
...
coroutine.wrap(UNQD_fake_script)()
local function KNQXPXK_fake_script() -- chatbot.LocalScript 
...
coroutine.wrap(KNQXPXK_fake_script)()
local function WFWUFL_fake_script() -- pladmin.LocalScript 
...
coroutine.wrap(WFWUFL_fake_script)()
local function FQJDG_fake_script() -- cxspy.LocalScript 
...
coroutine.wrap(FQJDG_fake_script)()
local function FSHPEF_fake_script() -- arsenal.LocalScript 
...
coroutine.wrap(FSHPEF_fake_script)()
local function LRZFSHU_fake_script() -- walkspeedbtn.LocalScript 
...
coroutine.wrap(LRZFSHU_fake_script)()
local function RLDMI_fake_script() -- toh.LocalScript 
...
coroutine.wrap(RLDMI_fake_script)()
local function OKIBDH_fake_script() -- sfreach.LocalScript 
...
coroutine.wrap(OKIBDH_fake_script)()
local function UDMFMV_fake_script() -- Loader.Dragify 
...
coroutine.wrap(UDMFMV_fake_script)()
local function LVMPI_fake_script() -- close_2.LocalScript 
...
coroutine.wrap(LVMPI_fake_script)()
local function EPUHSJP_fake_script() -- status.LocalScript 
	...
	function checkGame()
		if not indexOf(sg, 286090429) == -1 then
			return "ar"
		elseif not indexOf(sg, 155615604) == -1 then
			return "pl"
		elseif not indexOf(sg, 1962086868) == -1 then
			return "toh"
		else
			return false
		end
...
coroutine.wrap(EPUHSJP_fake_script)()
local function LNCYMO_fake_script() -- continuetohub.LocalScript 
...
coroutine.wrap(LNCYMO_fake_script)()
local function MUJXJV_fake_script() -- loading.LocalScript 
...
coroutine.wrap(MUJXJV_fake_script)()
